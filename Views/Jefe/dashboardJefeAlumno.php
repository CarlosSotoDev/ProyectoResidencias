...
<head>
    ...
    <title>Alumnos - Jefe de Carrera</title>
                ...
                <div class="table-responsive">
                    <table class="table table-striped table-sm text-center">
                        ...
                        <tbody>
                            ...
                            // Consulta para obtener los alumnos filtrados por la carrera del jefe de carrera
                            $query = "
                                SELECT a.ID_Alumno, a.Nombres, a.Apellido_Paterno, a.Apellido_Materno, c.Nombre_Carrera, u.Nombre_Usuario, p.Nombre_Proyecto
                                FROM alumno a
                                LEFT JOIN carrera c ON a.Carrera = c.ID_Carrera
                                LEFT JOIN usuario u ON a.ID_Usuario = u.ID_Usuario
                                LEFT JOIN proyecto p ON a.Proyecto = p.ID_Proyecto
                                WHERE a.Carrera = ? AND (
                            ...
                            if ($result && $result->num_rows > 0) {
                                ...
                                echo "<tr><td colspan='7'>No existe ningún alumno para esta carrera.</td></tr>";
                            }
                            ?>
                        </tbody>
                    </table>
